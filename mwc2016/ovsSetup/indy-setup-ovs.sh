...
sudo ovs-docker add-port mwc-br1 eth0 ems_ems_1 --ipaddress=10.42.11.100/24

echo "adding port of mme"
sudo ovs-docker add-port mwc-br1 eth0 mme_mme_1 --ipaddress=10.42.11.101/24

echo "adding port of hss"
sudo ovs-docker add-port mwc-br1 eth0 hss_hss_1 --ipaddress=10.42.11.102/24

echo "adding port of pcrf"
sudo ovs-docker add-port mwc-br1 eth0 pcrf_pcrf_1 --ipaddress=10.42.11.106/24

echo "adding port of sgw"
sudo ovs-docker add-port mwc-br1 eth0 sgw_sgw_1 --ipaddress=10.42.11.103/24

echo "adding port of pgw"
sudo ovs-docker add-port mwc-br1 eth0 pgw_pgw_1 --ipaddress=10.42.11.104/24

echo "adding port of sdn_fabric"
sudo ovs-docker add-port mwc-br1 eth0 fabric_fabric_1 --ipaddress=10.42.11.1/24
